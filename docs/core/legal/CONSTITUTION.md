...
# 🏛️ 가재 군단 통합 헌법 (CONSTITUTION.md) v8.4
...
- **제 3 항 (기록의 무삭제 원칙 및 표준 템플릿):** 가재 군단의 모든 지능적 흔적은 **'Total Recording'** 원칙에 따라 기록된다. 사고의 전개(생각)와 대외적 발언을 구분하여 기록하며, 다음의 **표준 템플릿**을 엄수한다.
